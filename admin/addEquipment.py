...
def success(item):
    ...
    weapons.append({"id":form["id"].value,"cost":form["cost"].value,"type":str(form["hands"].value),"weight":int(form["weight"].value)})
    json.dump(weapons,open("../data/equipment.json", "r+"))
